...
def handle_command(command, channel):
    ...
    default_response = "I'll message you daily around 9 am, good day :)"
...
if __name__ == "__main__":
    if slack_client.rtm_connect(with_team_state=False):
        ...
        while True:
            ...
            if channel != None:
                pathashalaChannel = channel


            current_time = str(datetime.datetime.now())[11:19]
            current_time_seconds = current_time[6:8]
            print(datetime.datetime.now().strftime("%A"))
            if current_time_seconds == "00":
                print("Hi, this comes only once every minute")
